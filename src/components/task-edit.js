...
import {DAYS, COLORS, DescriptionLength} from "../const.js";
...
const isAllowableDescriptionLength = (description) => {
  ...
  return length >= DescriptionLength.MIN && length <= DescriptionLength.MAX;
};
...
const getRepeatDaysFieldset = (isRepeatingTask, repeatingDaysMarkup) => {
...
const createTaskEditTemplate = (task, options = {}) => {
  ...
  return (
    `<article class="card card--edit card--${cardColorClass(activeColor)} ${getMarkupClass(isRepeatingTask, `card--repeat`)} ${getMarkupClass(isExpired, `card--deadline`)}">
      <form class="card__form" method="get">
        <div class="card__inner">
          ...
          <div class="card__settings">
            <div class="card__details">
              <div class="card__dates">
                ...
                ${getRepeatDaysFieldset(isRepeatingTask, repeatingDaysMarkup)}
              </div>
            </div>
          ...
          <div class="card__status-btns">
            <button class="card__save" type="submit" ${getSaveButtonCondition(isBlockSaveButton)}>save</button>
...
export default class TaskEdit extends AbstractSmartComponent {
  ...
  _subscribeOnEvents() {
    ...
    const cardColors = element.querySelector(`.card__colors-wrap`);
    if (cardColors) {
